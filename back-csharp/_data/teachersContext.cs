    ...
    public partial class teachersContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.Property(e => e.OwnerIp)
                    .HasMaxLength(40)
                    .HasColumnName("owner_ip");
            ...
            modelBuilder.Entity<Roster>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.CampusId, e.TeacherName, e.TeacherLastname1, e.TeacherLastname2 }, "roster_campus_id_teacher_name_teacher_lastname1_teacher_las_key")
                    .IsUnique();
